...
const express = require('express'), router = express.Router(), FrameworksController = require('../controllers/frameworks.controller'), FrameworksService = require('../services/frameworks.service');
router.use((req, res, next) => __awaiter(this, void 0, void 0, function* () {
    let data = yield FrameworksService.getFrameworks();
    if (data) {
        req.frameworks = data;
        next();
    }
...
//# sourceMappingURL=frameworks.routes.js.map