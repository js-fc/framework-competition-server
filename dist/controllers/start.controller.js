    ...
    createHost(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.body.user && req.body.user.id) {
                ...
                let result = yield StartService.createUser(req.users);
                if (result)
    ...
    updateHost(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.body.user && req.body.user.id) {
                ...
                req.users[req.body.user.id] = req.body.user;
                let result = yield StartService.updateUser(req.users);
                if (result)
                    return res.status(200).send(result);
                else
                    return res
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.query.id) {
                if (req.users.hasOwnProperty(req.query.id)) {
                    ...
                    let result = yield StartService.deleteUser(req.users);
                    if (result)
                        return res.status(200).send(result);
                    else
                        return res
